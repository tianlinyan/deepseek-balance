  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      function classifyCarrier(carrier) {
        ...
        // Level 1: the RPC carrier. A non-ok carrier is a transport/assembly
        // failure (gateway warming up, endpoint claim settling, ...) — retry.
        if (!carrier || carrier.ok !== true) return { kind: "transport" };
        ...
        if (payload.is_available === false) {
          return { kind: "business-error", message: "余额服务不可用" };
        }
       ...
       * Beijing peak hours (09–12, 14–18), green otherwise.
       *
      ...
      function BalanceDock(props) {
        ...
        var peakHint = peak ? "DeepSeek 高峰时段（北京时间 9:00-12:00、14:00-18:00）" : "DeepSeek 非高峰时段";
